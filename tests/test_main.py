...
class TestPushSwapOperations(unittest.TestCase):
    ...
    def test_swap_both_first_two_elements(self):
        empty_list_a = []
        empty_list_b = []
        one_element_list_a = [1]
        one_element_list_b = [2]
        valid_list_a = [2, 1, 3, 4, 5]
        valid_list_b = [7, 6, 8, 9, 10]
        ...
        result_a, result_b = push_swap_operations.swap_both_first_two_elements(valid_list_a, valid_list_b)
